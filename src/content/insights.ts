...
export const insights: Insight[] = [
  {
    ...
    date: "2026-03-04",
    readMinutes: 6,
    author: "Shaik Mohmed Ali",
    authorRole: "Founder & Managing Director",
    authorBio:
      "Shaik leads the studio's applied-AI work — most recently a per-unit product authentication system for a premium nutrition brand.",
    coverColor: "#0c2a2a",
    accentColor: "#d9b87a",
  ...
  },
  {
    ...
    authorRole: "Founder & Managing Director",
    authorBio:
      "Shaik leads brand-led web work for UAE founders — most recently a bilingual editorial site for a Dubai luxury wedding studio.",
    coverColor: "#1a1a1a",
    accentColor: "#b8893a",
  ...
  },
  {
    ...
    authorRole: "Founder & Managing Director",
    authorBio:
      "Shaik designs and builds web platforms for Dubai operators — real estate, retail and lifestyle brands that need software shaped to how they actually work.",
    coverColor: "#241a14",
    accentColor: "#e9c98e",
